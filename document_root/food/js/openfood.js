...
function popup_html (html_to_display, modalID, closeTarget, overlayClose) {
  ...
  $.modal(html_to_display, {
    overlayId:"simplemodal-overlay-"+modalID,
    containerId:"simplemodal-container-"+modalID,
    closeClass:"modalClose",
    closeHTML:'<a class="modalCloseImg" '+(closeTarget.length == 0 ? 'onclick="$.modal.close();"' : 'onclick="window.location=\''+closeTarget+'\'"')+' title="Close"></a>',
    focus:false,
    modal:true,
...
// function logout (delay) {
//   // Default delay = 0
//   if (delay === undefined) {
//     delay = 0;
//     }
//   setTimeout(function(){
//     location.assign("https://nebraskafood.xxx");
//     }, delay);
//   }
