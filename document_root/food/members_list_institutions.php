...
$rs = @mysqli_query ($connection, $sql) or die (debug_print ("ERROR: 782033 ", array ($sql, mysqli_error ($connection)), basename(__FILE__).' LINE '.__LINE__));
...
while ( $row = mysqli_fetch_array ($rs, MYSQLI_ASSOC) )
  {
    ...
    $rs2 = @mysqli_query ($connection, $sql2) or die (debug_print ("ERROR: 781831 ", array ($sql2, mysqli_error ($connection)), basename(__FILE__).' LINE '.__LINE__));
