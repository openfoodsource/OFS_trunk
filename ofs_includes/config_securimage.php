...
return array(
    ...
    'image_width'      => 450,       // width of captcha image in pixels
    ...
    'line_color'       => '#f8f4f0', // hex color for lines over text
    'num_lines'        => 5,         // # of lines to draw over text

    'wordlist_file'    => 'words.txt',     // text file for word captcha
    'use_wordlist'     => true,              // true to use word list
    ...
    // Additional configurations added for Open Food Source defaults
    'text_color'                    => '#446600',
    'image_bg_color'                => '#f8f4f0', // Suggest matching this to the web-page background color
    'noise_color'                   => '#444444', // Suggest matching this to the web-page background color
    ...
    'noise_level'                   => 6,
    'image_signature'               => '',
    'signature_color'               => 'aaaaaa',
    'signature_font'                => '', // bug (?) causes this to be the same font as ttf_file
    'font_ratio'                    => 0.8,
