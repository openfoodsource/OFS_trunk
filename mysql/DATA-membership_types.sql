...
INSERT INTO `membership_types` (`membership_type_id`, `set_auth_type`, `initial_cost`, `order_cost`, `order_cost_type`, `customer_fee_percent`, `producer_fee_percent`, `membership_class`, `membership_description`, `pending`, `enabled_type`, `revert_to`, `renew_cost`, `expire_after`, `expire_type`, `expire_message`) VALUES
