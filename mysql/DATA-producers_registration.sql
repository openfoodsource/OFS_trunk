...
INSERT INTO `producers_registration` (`pid`, `producer_id`, `member_id`, `business_name`, `website`, `products`, `practices`, `pest_management`, `productivity_management`, `feeding_practices`, `soil_management`, `water_management`, `land_practices`, `additional_information`, `licenses_insurance`, `organic_products`, `certifying_agency`, `agency_phone`, `agency_fax`, `organic_cert`, `date_added`) VALUES
