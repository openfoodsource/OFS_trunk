...
INSERT INTO `sites` (`site_id`, `site_type`, `site_short`, `site_long`, `delivery_type`, `site_description`, `delivery_charge`, `route_id`, `hub_id`, `truck_code`, `delivery_postal_code`, `inactive`) VALUES
