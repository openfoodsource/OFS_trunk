...
INSERT INTO `ofs_order_cycles` (`delivery_id`, `date_open`, `date_closed`, `order_fill_deadline`, `delivery_date`, `msg_all`, `msg_bottom`, `coopfee`, `invoice_price`, `producer_markdown`, `retail_markup`, `wholesale_markup`) VALUES
