...
while ( $row = mysqli_fetch_array ($result, MYSQLI_ASSOC) )
  {
    ...
    $display .= '</td>
      <td class="producer_links">'.
        (CurrentMember::auth_type('producer_admin') == true ? '<a class="producer" onclick="popup_src(\'edit_producer.php?action=edit&producer_id='.$producer_id.'&display_as=popup\', \'edit_producer\', \'\', false)">Edit</a>' : '').'
      </td>
