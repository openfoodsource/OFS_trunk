...
$page_subtitle_html = '<span class="subtitle">Full List by Product Number</span>';
$page_title = 'Products: Full List by Product Number';
...
$major_division = 'confirmed'; // Pick a row that is not zero and will match every product
...
$row_type = 'product_producer'; // Reflects the detail to show on each row (vs. what gets featured in the header)
