...
$page_subtitle_html = '<span class="subtitle">Changed &ndash; since '.DAYS_CONSIDERED_CHANGED.' days ago</span>';
$page_title = 'Products: Changed since '.DAYS_CONSIDERED_CHANGED.' days ago';
