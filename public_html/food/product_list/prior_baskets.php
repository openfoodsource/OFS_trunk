...
$page_subtitle_html = '<span class="subtitle">Prior Purchases &ndash; products that are currently available</span>';
$page_title = 'Products: Prior Purchases that are currently available';
